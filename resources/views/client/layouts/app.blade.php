...
<div class="wrapper-wide">
                ...
                <div id="content" class="col-xs-12">
                    ...
                    <div class="slideshow single-slider owl-carousel">
                        <div class="item"><a href="#"><img class="img-responsive"
                                                           src="{{asset('./client/image/slider/banner-2.jpg')}}"
                                                           alt="banner 2"/></a>
                        </div>
                        <div class="item"><a href="#"><img class="img-responsive"
                                                           src="{{asset('./client/image/slider/banner-1.jpg')}}"
                                                           alt="banner 1"/></a>
                        </div>
                    </div>
                    <!-- Slideshow End-->
                    ...
                    <div id="product-tab" class="product-tab">
                        ...
                        <div id="tab-featured" class="tab_content">
                            <div class="owl-carousel product_carousel_tab">
                                ...
                                <div class="product-thumb clearfix">
                                    <div class="image"><a href="#"><img
                                                src="{{asset('./client/image/product/sony_vaio_1-220x330.jpg')}}"
                                                alt="کفش راحتی مردانه" title="کفش راحتی مردانه"
                                                class="img-responsive"/></a></div>
                                    <div class="caption">
                                        <h4><a href="#">کفش راحتی مردانه</a></h4>
                                ...
                                <div class="product-thumb clearfix">
                                    <div class="image"><a href="#"><img
                                                src="{{asset('./client/image/product/canon_eos_5d_1-220x330.jpg')}}"
                                                alt="تیشرت آستین بلند مردانه"
                                                title="تیشرت آستین بلند مردانه"
                                                class="img-responsive"/></a></div>
                                    <div class="caption">
                                        <h4><a href="#">تیشرت آستین بلند مردانه</a></h4>
                    ...
                    <!-- دسته ها محصولات Slider Start -->
                    <h3 class="subtitle">البسه - <a class="viewall" href="#">نمایش همه</a></h3>
                    <div class="owl-carousel latest_category_carousel">
                        ...
                        <div class="product-thumb">
                            <div class="image"><a href=""><img src="{{asset('./client/image/product/macbook_5-220x330.jpg')}}"
                                                               alt="ژل حمام بانوان"
                    ...
                    <div id="carousel" class="owl-carousel nxt">
                        <div class="item text-center"><a href="#"><img
                                    src="{{asset('./client/image/product/apple_logo-100x100.jpg')}}"
                                    alt="پالم"
                                    class="img-responsive"/></a></div>
                        <div class="item text-center"><a href="#"><img
                                    src="{{asset('./client/image/product/canon_logo-100x100.jpg')}}"
                                    alt="سونی"
                                    class="img-responsive"/></a></div>
                        <div class="item text-center"><a href="#"><img
                                    src="{{asset('./client/image/product/apple_logo-100x100.jpg')}}"
            ...
            <div class="container">
                <div class="row">
                    <div class="contact col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        ...
                        <p>قالب HTML فروشگاهی مارکت شاپ. این یک بلاک مدیریت محتواست. شما میتوانید هر نوع محتوای html نوشتاری یا
                            تصویری را در آن قرار دهید.</p>
                        <img alt="" src="{{asset('./client/image/logo-small.png')}}">
                    </div>
            ...
            <div class="container">
                <div id="powered" class="clearfix">
                    <div class="powered_text pull-left flip">
                        <p>کپی رایت © 2016 فروشگاه شما | پارسی سازی و ویرایش توسط <a href="https://onescript.ir" target="_blank">وان
                                اسکریپت</a></p>
                    </div>
                    <div class="social pull-right flip"><a href="#" target="_blank"> <img data-toggle="tooltip"
                                                                                          src="{{asset('./client/image/socialicons/facebook.png')}}"
                                                                                          alt="Facebook" title="Facebook"></a> <a
                            href="#" target="_blank"> <img data-toggle="tooltip"
                                                           src="{{asset('./client/image/socialicons/twitter.png')}}"
                                                           alt="Twitter"
                                                           title="Twitter"> </a> <a href="#" target="_blank"> <img
                                data-toggle="tooltip" src="{{asset('./client/image/socialicons/google_plus.png')}}" alt="Google+"
                                title="Google+"> </a>
                        <a href="#" target="_blank"> <img data-toggle="tooltip"
                                                          src="{{asset('./client/image/socialicons/pinterest.png')}}"
                                                          alt="Pinterest" title="Pinterest"> </a> <a href="#" target="_blank">
                            <img data-toggle="tooltip" src="{{asset('./client/image/socialicons/rss.png')}}" alt="RSS"
                                 title="RSS"> </a></div>
                </div>
                <div class="bottom-row">
                    <div class="custom-text text-center">
                        <p>این یک بلاک مدیریت محتواست. شما میتوانید هر نوع محتوای html نوشتاری یا تصویری را در آن قرار دهید.<br>
                    ...
                    <div class="payments_types"><a href="#" target="_blank"> <img data-toggle="tooltip"
                                                                                  src="{{asset('./client/image/payment/payment_paypal.png')}}"
                                                                                  alt="paypal" title="PayPal"></a> <a href="#"
                                                                                                                      target="_blank">
                            <img data-toggle="tooltip" src="{{asset('./client/image/payment/payment_american.png')}}"
                                 alt="american-express"
                                 title="American Express"></a> <a href="#" target="_blank"> <img data-toggle="tooltip"
                                                                                                 src="{{asset('./client/image/payment/payment_2checkout.png')}}"
                                                                                                 alt="2checkout"
                                                                                                 title="2checkout"></a> <a
                            href="#" target="_blank"> <img data-toggle="tooltip"
                                                           src="{{asset('./client/image/payment/payment_maestro.png')}}"
                                                           alt="maestro" title="Maestro"></a> <a href="#" target="_blank"> <img
                                data-toggle="tooltip" src="{{asset('./client/image/payment/payment_discover.png')}}"
                                alt="discover"
                                title="Discover"></a> <a href="#" target="_blank"> <img data-toggle="tooltip"
                                                                                        src="{{asset('./client/image/payment/payment_mastercard.png')}}"
                                                                                        alt="mastercard" title="MasterCard"></a>
                    </div>
                </div>
            </div>
        </div>
        <div id="back-top"><a data-toggle="tooltip" title="بازگشت به بالا" href="javascript:void(0)" class="backtotop"><i
    ...
    <div id="twitter_footer" class="twit-right sort-order-1">
        ...
        <a class="twitter-timeline" href="https://twitter.com/" data-chrome="nofooter noscrollbar transparent" data-theme="light"
           data-tweet-limit="2" data-related="twitterapi,twitter" data-aria-polite="assertive"
    ...
    <div id="facebook" class="fb-right sort-order-2">
        ...
        <div class="fb-page" data-href="https://www.facebook.com/harnishdesign/" data-small-header="true"
            ...
            <div class="fb-xfbml-parse-ignore">
                <blockquote cite="https://www.facebook.com/harnishdesign/"><a href="https://www.facebook.com/harnishdesign/">هارنیش
                        دیزاین</a></blockquote>
            </div>
        </div>
        <div id="fb-root"></div>
