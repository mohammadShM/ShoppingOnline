...
@section('content')
    <div id="container">
        <div class="container">
            <!-- Breadcrumb Start-->
            <ul class="breadcrumb">
                <li itemscope itemtype=""><a href="/" itemprop="url"><span
                            itemprop="title"><i class="fa fa-home"></i></span></a></li>
                <li itemscope itemtype=""><a href="#" itemprop="url"><span
                            itemprop="title">{{$product->category->title_fa}}</span></a></li>
                <li itemscope itemtype=""><a href="#" itemprop="url"><span
            ...
            <div class="row">
                ...
                <div id="content" class="col-sm-9">
                    <div itemscope itemtype="https://schema.org/محصولات">
                        ...
                        <div class="row product-info">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="addthis_toolbox addthis_default_style"><a class="addthis_button_facebook_like"
                                        ...
                                        pi:pinit:url="https://www.addthis.com/features/pinterest"
                                        pi:pinit:media="https://www.addthis.com/cms-content/images/features/pinterest-lg.png"></a>
                        ...
                        <div class="owl-carousel related_pro">
                            ...
                            <div class="product-thumb">
                                <div class="image"><a href="product.html"><img src="image/product/ipod_shuffle_1-220x330.jpg"
                ...
                <aside id="column-right" class="col-sm-3 hidden-xs">
                    ...
                    <div class="side-item">
                        ...
                        <div class="product-thumb clearfix">
                            ...
                            <div class="caption">
                                <h4>
                                    <a href="https://demo.harnishdesign.net/opencart/marketshop/v1/index.php?route=product/product&amp;product_id=42">تی
